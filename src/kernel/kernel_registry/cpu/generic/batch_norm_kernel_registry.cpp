...
//
#include "kernel/cpu/generic/batch_norm_kernel.h"
...
REGISTER_KERNEL_CREATOR(
    GenericKernelKeyGenerator::generate(DeviceType::CPU,IsaType::Generic,OpType::BatchNormalization,
        DataType::Float32),
    &GenericKernelCreator<cpu::generic::BatchNormKernel<float>>::instance());
