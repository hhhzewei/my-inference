...
GENERIC_REGISTER_KERNEL(
    cpu::ConvKeyGenerator::generate(DeviceType::CPU,IsaType::Generic,OpType::Conv,DataType::Float32,2,ConvType::Standard),
    cpu::StandardConv2DKernel<float>);
GENERIC_REGISTER_KERNEL(
    cpu::ConvKeyGenerator::generate(DeviceType::CPU,IsaType::Generic,OpType::Conv,DataType::Float32,2,ConvType::Depthwise),
    cpu::DepthwiseConv2dKernel<float>);
GENERIC_REGISTER_KERNEL(
    cpu::ConvKeyGenerator::generate(DeviceType::CPU,IsaType::Generic,OpType::Conv,DataType::Float32,2,ConvType::Grouped),
