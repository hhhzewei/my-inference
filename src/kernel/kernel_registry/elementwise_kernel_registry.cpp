...
GENERIC_REGISTER_KERNEL(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Add,DataType::Float32,false),
    cpu::BinaryElementwiseKernel<float, AddFunctor<float>>);
GENERIC_REGISTER_KERNEL(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Sub,DataType::Float32,false),
    cpu::BinaryElementwiseKernel<float, SubFunctor<float> >);
GENERIC_REGISTER_KERNEL(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Mul,DataType::Float32,false),
    cpu::BinaryElementwiseKernel<float, MulFunctor<float> >);
GENERIC_REGISTER_KERNEL(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Div,DataType::Float32,false),
    cpu::BinaryElementwiseKernel<float, DivFunctor<float> >);
// with stride
REGISTER_KERNEL_CREATOR(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Add,DataType::Float32,true),
    &(cpu::BinaryElementwiseKernelWithStrideCreator<AddFunctor<float>,float>::instance()));
REGISTER_KERNEL_CREATOR(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Sub,DataType::Float32,true),
    &(cpu::BinaryElementwiseKernelWithStrideCreator<SubFunctor<float>,float>::instance()));
REGISTER_KERNEL_CREATOR(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Mul,DataType::Float32,true),
    &(cpu::BinaryElementwiseKernelWithStrideCreator<MulFunctor<float>,float>::instance()));
REGISTER_KERNEL_CREATOR(
    ElementwiseKeyGenerator::generate(DeviceType::CPU,isa_type::Default,OpType::Div,DataType::Float32,true),
